...
public class VaccinationCenter {
    ...
    private static void addPatient() {
        ...
        while (true) {
            ...
            if (vaccineCount == 0) { // check for vaccine count == 0
                ...
                break;
            } else if (returnChar == ' ' || returnChar == 'Y') {
                do { // this loop validates user input
                    String inputPattern = "[YN]+";
                    System.out.print("\nTo Add Patient, Enter 'Y/y' or Enter 'N/n' to go back to Main Menu: ");
    ...
    private static void addPatientDetails() {
        ...
        while (true) {
            ...
            if (vaccineType == 1 && (isEditable[0] || isEditable[1])) {
                break;
            } else if (vaccineType == 2 && (isEditable[2] || isEditable[3])) {
                break;
            } else if (vaccineType == 3 && (isEditable[4] || isEditable[5])) {
                break;
            } else {
                System.out.println("Selected Vaccination Type Booths Occupied.\nChoose Different Vaccine Type");
            }
        }
        ...
        while (true) {
            ...
            if (boothNumber <= 5) {
                if (!booth[boothNumber].getFirstName().equals("*")) {
                    ...
                    booth[boothNumber].setSurname("*");
                    booth[boothNumber].setAge(0);
                    booth[boothNumber].setCity("*");
                    booth[boothNumber].setIdNumber("*");
                    booth[boothNumber].setVaccineType(0);
